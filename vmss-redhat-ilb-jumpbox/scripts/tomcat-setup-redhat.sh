...
# Source: https://github.com/Azure/azure-quickstart-templates/tree/052db5feeba11f85d57f170d8202123511f72044/vsts-tomcat-redhat-vm
...
cd /home/$1
wget http://www-us.apache.org/dist/tomcat/tomcat-connectors/jk/tomcat-connectors-1.2.42-src.tar.gz >> /home/$1/install.out.txt 2>&1
tar xvfz tomcat-connectors-1.2.42-src.tar.gz >> /home/$1/install.out.txt 2>&1
cd /home/$1/tomcat-connectors-1.2.42-src/native/
